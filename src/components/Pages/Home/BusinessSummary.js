...
const BusinessSummary = () => {
  return (
    <div className=" my-5 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
      {/*  */}
      <div className=" text-gray-600 bg-slate-100 border-[1px] border-gray-200  rounded-md  w-52 p-5 flex flex-col items-center justify-center  shadow-lg">
        <div className="my-4">
          <span>
        ...
        <div className="title1 ">
          ...
          <h3 className=" text-lg font-semibold">Happy Customer</h3>
        </div>
      </div>
      ...
      <div className=" text-gray-600 bg-slate-100 border-[1px] border-gray-200 rounded-md w-52 p-5 flex flex-col items-center justify-center  shadow-lg">
        ...
        <div className="title1 ">
          ...
          <h3 className=" text-lg font-semibold">Product Delivered</h3>
        </div>
      </div>
      ...
      <div className=" text-gray-600 bg-slate-100 border-[1px] border-gray-200 rounded-md w-52 p-5 flex flex-col items-center justify-center  shadow-lg">
        ...
        <div className="title1 ">
          ...
          <h3 className=" text-lg font-semibold">Tools Items</h3>
        </div>
      </div>
