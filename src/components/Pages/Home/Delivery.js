  ...
  return (
    <div className=" grid grid-cols-2 lg:grid-cols-4 px-10 mt-8 gap-8">
      <div className=" bg-slate-300 rounded-md w-72 p-5 flex items-center justify-center gap-8 shadow-lg">
        <div>
          <span className="">
            <i class="fa-solid fa-briefcase  text-5xl text-yellow-600"></i>
          </span>
        </div>
      ...
      <div className=" bg-slate-300 rounded-md w-72 p-5 flex items-center justify-center gap-8 shadow-lg">
        <div>
          <span className="">
            <i class="fa-solid fa-truck  text-4xl text-yellow-600"></i>
          </span>
        </div>
        <div className="title1 text-gray-600">
      ...
      <div className=" bg-slate-300 rounded-md w-72 p-5 flex items-center justify-center gap-8 shadow-lg">
        <div>
          <span className="">
            <i class="fa-solid fa-money-check-dollar   text-5xl text-yellow-600"></i>
          </span>
        </div>
        <div className="title1 text-gray-600">
      ...
      <div className=" bg-slate-300 rounded-md w-72 p-5 flex items-center justify-center gap-8 shadow-lg">
        <div>
          <span className="">
            <i class="fa-solid fa-headset  text-5xl text-yellow-600"></i>
          </span>
        </div>
        <div className="title1 text-gray-600">
